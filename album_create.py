...
def gallery():
    ...
    return render_template_string('''<!DOCTYPE html><head>
        <meta charset="UTF-8"><!--//
    Generated by FindAImage - https://github.com/themanyone/FindAImage
        //-->
    ...
    <a class="button" id="ai_caption_all" title="Caption all media not already captioned using AI">AI Caption All</a>
