    ...
    with gr.Row(equal_height=False):
        ...
        with gr.Column(scale=1):
            with gr.Row(equal_height=False):
                ...
                html_output = gr.HTML("""
        <div style='height: 100%; padding: 20px; background: #234; color: #EEE;'>
            <p>Your ad here</p>
            <p>q
            <a href="https://www.paypal.com/donate/?hosted_button_id=A37BWMFG3XXFG">Support further development</a></p>
        </div>
        """)
